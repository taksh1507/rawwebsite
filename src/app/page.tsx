        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
          ...
          >
            <h2 style={{
              ...
              Latest <span style={{ color: 'var(--color-red)' }}>Updates</span>
            </h2>
          </motion.div>
          ...
          >
            {[
              { date: 'Dec 5, 2025', title: 'New Autonomous Bot Released', icon: '🚀' },
              { date: 'Dec 1, 2025', title: 'Won RoboRace Championship 2025', icon: '🥇' },
              { date: 'Nov 25, 2025', title: '5 New Members Joined the Team', icon: '👥' },
            ].map((news, idx) => (
              <motion.div
                key={idx}
                style={{
                ...
                whileHover={{
                  y: -5,
                  boxShadow: '0 15px 40px rgba(225, 6, 0, 0.1)',
                }}
              >
