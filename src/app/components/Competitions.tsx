...
const competitionsData = [
  ...
  },
  {
    ...
    description: 'Completed pre-registration for DD Robocon 2026 - India\'s most prestigious robotics competition. Preparing to compete at the national level with our innovative robot design.',
